...
const rawEvents: EventItem[] = [
  ...
  },
  {
    ...
    date: "2026-09-16",
    description: "One day building AI tools with the people who serve our communities. With the Province of Antwerp and AP Hogeschool, builders take on real public-sector challenges, mentored by the officers who run them.",
    thumbnail: "/province/cover.jpg",
    status: "upcoming",
    organizationType: "ORGANIZED",
    link: "/province",
    featured: true,
